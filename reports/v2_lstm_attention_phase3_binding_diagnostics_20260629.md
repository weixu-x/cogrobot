...
Scope: frozen probes for checkpoint epoch 17. Only probe heads are trained.

## Artifacts

- JSON: `reports/v2_lstm_attention_phase3_binding_diagnostics_20260629.json`
- Report: `reports/v2_lstm_attention_phase3_binding_diagnostics_20260629.md`
- Config: `corsi/experiments/corsi_memory_recall_v2/configs/memory_recall_v2_k12_lstm_attention_dmem64.json`
- Checkpoint: `corsi_artifacts/memory_recall_v2/runs/corsi_memory_recall_v2_k12/stage2_seed0_lstm_attention_dmem64_20260629/best_full_sequence.pt`
...
| 4 | 5 | 1.000 | 1.000 | 0.000 |
| 5 | 5 | 1.000 | 1.000 | 0.000 |
| 6 | 5 | 1.000 | 1.000 | 0.000 |
| 7 | 5 | 1.000 | 1.000 | 0.000 |
| 8 | 5 | 1.000 | 1.000 | 0.000 |
| 9 | 5 | 1.000 | 1.000 | 0.000 |
...
| --- | --- | --- | --- | --- | --- |
| final h | 0.377 | 0.125 | 1.000 | 0.200 | 0.400 |
| final c | 0.477 | 0.175 | 1.000 | 0.400 | 0.600 |
| final [h;c] | 0.441 | 0.100 | 1.000 | 0.200 | 0.400 |
...
Trajectory [h_t;c_t] test probes: current item 1.000, write position 1.000.
Final [h;c] test probes: ordered identity token 0.441, length 1.000.
